...
class AttendancesControllerTest < ActionController::TestCase
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post :create, attendance: { attending: @attendance.attending, date: @attendance.date, scout_id: @attendance.scout_id }
    end
  ...
  test "should update attendance" do
    patch :update, id: @attendance, attendance: { attending: @attendance.attending, date: @attendance.date, scout_id: @attendance.scout_id }
    assert_redirected_to attendance_path(assigns(:attendance))
  end
